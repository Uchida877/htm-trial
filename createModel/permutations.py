...
'/Users/user/.local/lib/python2.7/site-packages/nupic/swarming/exp_generator/experiment_generator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'sine': PermuteEncoder(maxval=1, fieldName='sine', w=21, clipInput=True, minval=-1, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
